...
performSkillExecution(action, context)
  ...
  └── buildEffectsFromContext(context)
        ...
        ├── context.statusEffectEvents[]  → effects type "statusEffectApplied" / "statusEffectRemoved"
...
context = {
  ...
  statusEffectEvents: [],            // { targetId, statusEffect, action: "add"|"remove" }
...
function buildEffectsFromContext(context) {
  ...
  // ... idem para buffEvents, statusEffectEvents, shieldEvents
