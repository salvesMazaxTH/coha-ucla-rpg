...
TASKS_DIR="C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/tasks"
if [ -d "$TASKS_DIR" ]; then
  STALE_COUNT=$( (find "$TASKS_DIR" -maxdepth 1 -type d -mtime +1 2>/dev/null || true) | wc -l )
  if [ "$STALE_COUNT" -gt 0 ]; then
    echo "⚠️  Found $STALE_COUNT stale task directories in C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/tasks/"
    echo "   These are leftover from crashed subagent sessions."
    echo "   Run: rm -rf C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/tasks/*  (safe — only affects dead sessions)"
  fi
fi
```
