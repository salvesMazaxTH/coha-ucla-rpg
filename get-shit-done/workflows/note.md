...
- **Global scope**: `C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/notes/`)
...
2. Glob `C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/notes/` — works in any directory
