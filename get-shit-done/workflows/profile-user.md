...
Key references:
- @C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/get-shit-done/references/ui-brand.md (display patterns)
- @C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/get-shit-done/USER-PROFILE.md"
...
```bash
cp "C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/get-shit-done/USER-PROFILE.md" "C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/get-shit-done/references/user-profiling.md`
...
Reference: @C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .clinerules" -- "Add profile to C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/.clinerules for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/.clinerules"
...
```bash
BACKUP_PATH="C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/USER-PROFILE.backup.md"
```
...
Your profile:    C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/commands/gsd/dev-preferences.md
  ✓ .clinerules section       .clinerules
  ✓ Global .clinerules        C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/.clinerules
```
