...
```bash
node "C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `C:/Users/Thiago/Desktop/thiago recreativo diverso/coding related/coha-ucla-rpg/CoHA (UCLA RPG) (ultômetro)/get-shit-done/templates/retrospective.md`.
